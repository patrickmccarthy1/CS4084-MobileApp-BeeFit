...
public class beeMaps extends AppCompatActivity implements OnMapReadyCallback {
        ...
        public void onMapReady(GoogleMap googleMap) {
            ...
            map.setInfoWindowAdapter(new CustomInfoWindowAdapter(beeMaps.this));
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(beeMaps.this);
        //button click navigates user to MainActivityMap
        ...
        backButtonMap.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //instantiate intent so button can launch MainActivityMap
                Intent intent = new Intent(beeMaps.this,MainActivityMap.class);
